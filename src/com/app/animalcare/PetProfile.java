    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (savedInstanceState == null) {
            getSupportFragmentManager().beginTransaction()
                    ...
                    .commit();
            String[] events = {"Nueva vacuna", "Medicinas", "Visitas a veterinario", "Directorio de veterinarios"};
            ListView eventList = (ListView) findViewById(R.id.optionList);
            ArrayAdapter eventAdapter = new ArrayAdapter<String>(this, R.layout.options_list, R.id.optionItem, events);
